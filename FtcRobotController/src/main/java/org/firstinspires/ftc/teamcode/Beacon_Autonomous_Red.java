...
public class Beacon_Autonomous_Red extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (!RedPressed && opModeIsActive()) {
            ...
            RedPressed = redlevelLeft >= 4 && redlevelRight >= 4;
            if (do_telemetry) {telemetry.addData("Red Level Left", redlevelLeft);}
            if (do_telemetry) {telemetry.addData("Red Level Right", redlevelRight);}
        }
