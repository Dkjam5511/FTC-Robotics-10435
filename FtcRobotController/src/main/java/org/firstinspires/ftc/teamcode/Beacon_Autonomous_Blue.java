...
public class Beacon_Autonomous_Blue extends LinearOpMode {
    ...
    double white_level;
    double inside_correction = .01;
    double outside_correction = .08;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        */
        ...
        while (!found_white && opModeIsActive()) {
            if (!do_telemetry) {leftWheel.setPower(wheelpower_base + .01);}  // The .01 is because our left motors is weak
