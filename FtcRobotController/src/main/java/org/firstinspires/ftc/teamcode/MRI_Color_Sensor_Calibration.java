...
public class MRI_Color_Sensor_Calibration extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        telemetry.addData("HELLO", "Press A for Right Sensor, B for Left Sensor");
        telemetry.update();
        ...
        if (gamepad1.a) {
            colorC = hardwareMap.i2cDevice.get("cs_right");
            colorCreader = new I2cDeviceSynchImpl(colorC, I2cAddr.create8bit(0x3c), false);
        } else {
            colorC = hardwareMap.i2cDevice.get("cs_left");
        ...
        // wait until they have released the button
        while (gamepad1.a || gamepad1.b) {
